...
namespace ZEGO
{
     ...
     */
    public delegate void OnRoomLoginResult(int errorCode, string extendedData);
     ...
     * @param extendedData Extended Information
     */
    public delegate void OnRoomLogoutResult(int errorCode, string extendedData);
     ...
     */
    public delegate void OnPublisherTakeSnapshotResult(int errorCode, IntPtr image);
     ...
     * @param image Snapshot image
     */
    public delegate void OnPlayerTakeSnapshotResult(int errorCode, IntPtr image);
