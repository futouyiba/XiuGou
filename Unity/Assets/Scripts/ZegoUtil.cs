...
namespace ZEGO
{
    class ZegoUtil
    {
        ...
        public static void GetStructListByPtr<StructType>(ref List<StructType> list, IntPtr ptr, uint count)
        {
        ...
        public static bool IsUnity3D()
        {
            return (ZegoConstans.MODULE == ZegoConstans.MOUDLE_U3D);
        }

        public static bool IsDotnet()
        {
            return (ZegoConstans.MODULE == ZegoConstans.MODULE_DOT_NET);
        }
        ...
        public static void ZegoPrivateLog(int errorCode, string log, bool handleDebugFlag, int module, bool writeFile = true, [CallerMemberName] string funcName = "")
        {
    ...
    class ZegoCallBackChangeUtil
    {
        ...
        public static Dictionary<string, ZegoSoundLevelInfo> ChangeZegoSoundLevelInfoStructListToDictionaryAll(zego_sound_level_info[] infos)
        {
            Dictionary<string, ZegoSoundLevelInfo> keyValuePairs = new Dictionary<string, ZegoSoundLevelInfo>();
            for (int i = 0; i < infos.Length; i++)
            {
                string stream_id = ZegoUtil.GetUTF8String(infos[i].stream_id);
        ...
        public static ZegoNetWorkResourceCache ChangeZegoNetWorkResourceCacheStructToClass(zego_network_resource_cache cache)
        {
        ...
        public static ZegoNetworkTimeInfo ChangeZegoNetworkTimeInfoStructToClass(zego_network_time_info info)
        {
        ...
        public static ZegoSoundLevelInfo ChangeZegoSoundLevelInfoStructToClass(zego_sound_level_info info)
        {
    ...
    class ZegoImplCallChangeUtil
    {
        ...
        public static zego_player_config ChangeZegoPlayerConfigClassToStruct(ZegoPlayerConfig config)
        {
            ...
            else
            {
                ...
                zegoPlayerConfig.video_codec_id = config.videoCodecID;
                zegoPlayerConfig.source_resource_type = config.sourceResourceType;
        ...
        public static zego_cdn_config ChangeCDNConfigClassToStruct(ZegoCDNConfig cDNConfig)
        {
            ...
            if (cDNConfig != null)
            {
                ...
                ZegoUtil.ZegoCopy(cDNConfig.authParam, ref config.auth_param, ZEGO_EXPRESS_MAX_COMMON_LEN);
        ...
        public static zego_mixer_input ChangeZegoMixerInputClassToStruct(ZegoMixerInput zegoMixerInput)
        {
            ...
            if (zegoMixerInput != null)
            {
                ...
                zego_Mixer_Input.label.font.border_color = zegoMixerInput.label.font.borderColor;
        ...
        public static zego_reverb_advanced_param ChangeZegoReverbAdvancedParamClassToStruct(ZegoReverbAdvancedParam _param)
        {
        ...
        public static zego_reverb_echo_param ChangeZegoReverbEchoParamClassToStruct(ZegoReverbEchoParam _param)
        {
        ...
        public static zego_accurate_seek_config ChangeZegoAccurateSeekConfigClassToStruct(ZegoAccurateSeekConfig config)
        {
            if(config == null)
            {
        ...
        public static zego_copyrighted_music_config ChangeZegoCopyrightedMusicConfigClassToStruct(ZegoCopyrightedMusicConfig config)
        {
            ...
            else
            {
                ...
                ZegoUtil.ZegoCopy(config.user.userID, ref user_info.user_id, ZEGO_EXPRESS_MAX_USERID_LEN);
                ZegoUtil.ZegoCopy(config.user.userName, ref user_info.user_name, ZEGO_EXPRESS_MAX_USERNAME_LEN);
        ...
        public static zego_copyrighted_music_request_config ChangeZegoCopyrightedMusicRequestConfigClassToStruct(ZegoCopyrightedMusicRequestConfig config)
        {
            ...
            else
            {
                ...
                request_config.mode = config.mode;
                ZegoUtil.ZegoCopy(config.songID, ref request_config.song_id, ZEGO_EXPRESS_MAX_COMMON_LEN);
                return request_config;
            }
        }

        public static zego_auto_mixer_task ChangeZegoAutoMixerTaskFromClassToStruct(ZegoAutoMixerTask task)
        {
            if(task == null)
            {
            ...
            else
            {
                ...
                ZegoUtil.ZegoCopy(task.roomID, ref mixer_task.room_id, ZegoConstans.ZEGO_EXPRESS_MAX_ROOMID_LEN);
                mixer_task.stream_alignment_mode = task.streamAlignmentMode;
                ZegoUtil.ZegoCopy(task.taskID, ref mixer_task.task_id, ZegoConstans.ZEGO_EXPRESS_MAX_MIXER_TASK_LEN);
