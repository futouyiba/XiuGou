...
public class Scatter : MonoBehaviour
{
    ...
    [SerializeField] private int scatterTimesX = 30;
    [SerializeField] private int scatterTimesZ = 30;

    [SerializeField] private float spawnRate = 0.5f;
    [SerializeField] private GameObject[] spriteGOs;
    public static Scatter instance;

    private string[] names;
    public object ObjectPool { get; set; }
