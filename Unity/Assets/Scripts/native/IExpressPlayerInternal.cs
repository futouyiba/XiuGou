...
namespace ZEGO
{
    public class IExpressPlayerInternal
    {
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_start_playing_stream", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_start_playing_stream_with_config", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_stop_playing_stream", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_state_update_callback", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_recv_audio_first_frame_callback", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_recv_video_first_frame_callback", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_render_video_first_frame_callback", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_video_size_changed_callback", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
        ...
        ///user_context: void*
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_recv_sei_callback", CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
