...
typedef void(^ZegoCopyrightedMusicRequestAccompanimentClipCallback)(int errorCode, NSString *resource);
...
@property ZegoVideoCodecID videoCodecID;

/// The resource type of the source stream.
@property ZegoResourceType sourceResourceType;
