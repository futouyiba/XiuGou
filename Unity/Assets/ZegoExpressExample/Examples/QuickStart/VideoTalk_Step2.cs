...
public class VideoTalk_Step2 : MonoBehaviour
{
    ...
    void Start()
    {
        notDestroyObj = GameObject.Find("EventSystem").GetComponent<VideoTalk>();
    ...
    public void LoginRoom()
    {
        ...
        //config.token = "73ecb5e3e69aa811ce98c5ea40a09a12";

        ZegoUtilHelper.PrintLogToView(string.Format("LoginRoom, roomID:{0}, userID:{1}, userName:{2}, token:{3}", notDestroyObj.roomID, notDestroyObj.user.userID/*"1666228805"*/, notDestroyObj.user.userName, config.token));
