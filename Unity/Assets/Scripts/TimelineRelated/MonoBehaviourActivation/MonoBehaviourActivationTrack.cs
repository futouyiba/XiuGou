...
[TrackColor(0.8301887f, 0.7190237f, 0.2858669f)]
[TrackClipType(typeof(MonoBehaviourActivationClip))]
[TrackBindingType(typeof(MonoBehaviour))]
public class MonoBehaviourActivationTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<MonoBehaviourActivationMixerBehaviour>.Create (graph, inputCount);
    }
