...
namespace ZEGO
{
    ...
    public struct zego_reverb_advanced_param
    {
        ...
        public float tone_low;

        /** Tone High. 100% by default */
        public float tone_high;
    ...
    public struct zego_player_config
    {
        ...
        public ZegoResourceType source_resource_type;
    }
    ...
    * The NTP info
    */
    public struct zego_network_time_info
    {
    ...
    */
    public struct zego_accurate_seek_config
    {
    ...
    */
    public struct zego_network_resource_cache
    {
