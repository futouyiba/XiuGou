...
public class EventMicExample : MonoBehaviour {
 ...
 energy;
    public UnityEngine.UI.Text kick;
    public UnityEngine.UI.Text snare;
    public UnityEngine.UI.Text hithat;
    ...
    private IEnumerator showText(UnityEngine.UI.Text texto, GameObject objeto)
    {
        texto.enabled = true;
