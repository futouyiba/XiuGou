...
namespace nsOnset
{
    class OnsetDetection
    {
        ...
        int SampleSize;
        //不知道单位是不是hz，试试看
        private float UnitySampleRate =44100;
        ...
        // Constructor
        public OnsetDetection(AudioClip audioClip, int sampleWindow)
        {
            this._audioClip = audioClip;
            UnitySampleRate = this._audioClip.frequency;
       ...
       //         / (float)PCM.WaveFormat.SampleRate
            ...
            float thresholdTimeSpan, float thresholdMultiplier)
        {
            ...
            float sourceTimeSpan = (float)(sampleWindow) / UnitySampleRate;
        ...
        public float TimePerSample()
        {
            ...
            return (float) SampleSize / UnitySampleRate;
        }
